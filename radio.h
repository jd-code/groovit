/* 
 * $Id: radio.h,v 1.2 2003/03/19 16:45:47 jd Exp $
 ...
 *
 * Revision 1.2.0.22.0.1  1999/09/15 09:47:15  jd
 * Initial revision
 *
 *
 */
...
#define CONTMAXRADIO	64	/* nombre max de controls dans une struct Radio (pour
				   allocation) */

typedef struct STRadio
{
    int     value, nb, h[CONTMAXRADIO];
}
Radio;
